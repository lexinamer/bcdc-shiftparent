...
function bcdc_shiftparent_setup() {
	 ...
	 * If you're building a theme based on SHIFT NC Parent, use a find and replace
	 * to change 'bcdc-shiftparent' to the name of your theme in all the template files.
	 */
